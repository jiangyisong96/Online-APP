...
echo "exporting environment variables from export_windows_firefox_environment_variables.sh"

# at browserstack, tests ran with the same BUILD_NUMBER will be grouped together
CURRENTDATE=`date +"%Y-%m-%d-%H%M%S"`
export BUILD_NUMBER="Test-Windows-firefox-"$CURRENTDATE
...
export CANDIDATE_ACS_NRIC_SC=S1110600E
export CANDIDATE_ACS_NRIC_PR=S1110610E
export CANDIDATE_ACS_NRIC_IS=S1110620E

export CANDIDATE_SJI_NRIC_SC=S1110660E
export CANDIDATE_SJI_NRIC_SC2=S1110670E

export CANDIDATE_ITE_NRIC_SC=S1110390E
export CANDIDATE_ITE_NRIC_PR=S1110400E
export CANDIDATE_ITE_NRIC_IS=S1110410E

export CANDIDATE_PEB_NRIC_SC=S1110420E
export CANDIDATE_PEB_NRIC_PR=S1110430E
export CANDIDATE_PEB_NRIC_IS=S1110440E

export CANDIDATE_ITE_USERNAME=candidateUat711
export CANDIDATE_ITE_PASSWORD=P@ssw0rd1234

export CANDIDATE_ACS_USERNAME=candidateUat721
export CANDIDATE_ACS_PASSWORD=P@ssw0rd1234

export CANDIDATE_HCI_USERNAME=candidateUat691
