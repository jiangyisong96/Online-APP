...
echo "exporting environment variables from export_mac_firefox_environment_variables.sh"

# at browserstack, tests ran with the same BUILD_NUMBER will be grouped together
CURRENTDATE=`date +"%Y-%m-%d-%H%M%S"`
export BUILD_NUMBER="Test-mac-firefox-"$CURRENTDATE
...
export CANDIDATE_ACS_NRIC_SC=S1110604E
export CANDIDATE_ACS_NRIC_PR=S1110614E
export CANDIDATE_ACS_NRIC_IS=S1110624E

export CANDIDATE_SJI_NRIC_SC=S1110664E
export CANDIDATE_SJI_NRIC_SC2=S1110674E

export CANDIDATE_ITE_NRIC_SC=S1110394E
export CANDIDATE_ITE_NRIC_PR=S1110404E
export CANDIDATE_ITE_NRIC_IS=S1110414E

export CANDIDATE_PEB_NRIC_SC=S1110424E
export CANDIDATE_PEB_NRIC_PR=S1110434E
export CANDIDATE_PEB_NRIC_IS=S1110444E

export CANDIDATE_ITE_USERNAME=candidateUat714
export CANDIDATE_ITE_PASSWORD=P@ssw0rd1234

export CANDIDATE_ACS_USERNAME=candidateUat724
export CANDIDATE_ACS_PASSWORD=P@ssw0rd1234

export CANDIDATE_HCI_USERNAME=candidateUat694
export CANDIDATE_HCI_PASSWORD=P@ssw0rd1234

export CANDIDATE_YRS_USERNAME=candidateUat704
