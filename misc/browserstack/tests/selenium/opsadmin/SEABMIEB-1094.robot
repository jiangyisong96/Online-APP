...
${name}   TestName6239
${email}   sampleemail012@gmail.com
${msg}   Enter the 6-digit One-Time Password (OTP) sent to your mobile no.
${success_msg}   Your request has been submitted for approval.

*** Test Cases ***
Ops admin create private centre coordinator so that coordinator is able to login to view/edit personal details and set default 2FA as SMS

        [Setup]   Custom Setup   ${URL}

        #Set session name
        Custom Session Name   SEABMIEB-1094
        ...
        #Select "Miss" from the options
        #ToDo Need to add id for salutation dropdown options
        ...
        #Select "head of department" option
        ...
        #Validate if success msg present
