...
Private Centre Coordinator success to manual register the Candidates for resit and make payment by Credit Card, so that Candidates can resit the mid year A-level MT exam
        ...
        #Set session name
        Custom Session Name   SEABMIEB-1161
        ...
        Wait Until Element Is Enabled   id=radio-manual
        ...
        ${CANDIDATE_ACS2_NAME}=   Get Text   id=text-candidateName-row0
        ...
        ${CANDIDATE_ACS2_SUBJECTCODE}=   Get Text   id=text-subjectCode-row0
        ...
        Custom Resit Group Register Validation   ${CANDIDATE_ACS2_NAME}   %{CANDIDATE_ACS_NRIC_SC}   ${CANDIDATE_ACS2_SUBJECTCODE}
